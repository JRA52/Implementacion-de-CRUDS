...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { city_id: @empresa.city_id, name: @empresa.name, rif: @empresa.rif, telefono: @empresa.telefono } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { city_id: @empresa.city_id, name: @empresa.name, rif: @empresa.rif, telefono: @empresa.telefono } }
